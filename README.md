...
- [x] Enumerations → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Enumerations)
- [x] Tuples → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Tuples)
  - [x] Simula'sSoup → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Tuples/Simula'sSoup)
- [x] Classes → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Classes)
  - [x] VinFletcher'sArrows → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Classes/VinFletcher'sArrows)
- [x] InformationHiding → [Folder](./Challenges/Part2-ObjectOrientedProgramming/InformationHiding)
  - [x] Vin'sTrouble → [Folder](./Challenges/Part2-ObjectOrientedProgramming/InformationHiding/Vin'sTrouble)
- [x] Properties → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Properties)
  - [x] ThePropertiesOfArrows → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Properties/ThePropertiesOfArrows)
- [x] Static → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Static)
  - [x] ArrowFactories → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Static/ArrowFactories)
- [x] CatacombsOfTheClass → [Folder](./Challenges/Part2-ObjectOrientedProgramming/CatacombsOfTheClass)
  - [x] TheCard →  [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheCatacombsOfTheClass/TheCard)
  - [x] TheColor →  [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheCatacombsOfTheClass/TheColor/TheColor)
  - [x] TheLockedDoor →  [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheCatacombsOfTheClass/TheLockedDoor)
  - [x] ThePasswordValidator →  [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheCatacombsOfTheClass/ThePasswordValidator)
  - [x] ThePoint →  [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheCatacombsOfTheClass/ThePoint/ThePoint)
- [ ] Inheritance → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Inheritance)
- [ ] Polymorphism → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Polymorphism)
- [ ] Interfaces → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Interfaces)
- [ ] Structs → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Structs)
- [ ] Records → [Folder](./Challenges/Part2-ObjectOrientedProgramming/Records)
- [ ] GenericTypes → [Folder](./Challenges/Part2-ObjectOrientedProgramming/GenericTypes)
- [ ] TheFountainOfObjects → [Folder](./Challenges/Part2-ObjectOrientedProgramming/TheFountainOfObjects)
- [ ] SomeUsefulTypes → [Folder](./Challenges/Part2-ObjectOrientedProgramming/SomeUsefulTypes)
